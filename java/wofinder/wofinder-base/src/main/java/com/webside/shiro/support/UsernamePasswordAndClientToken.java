...
public final class UsernamePasswordAndClientToken  implements HostAuthenticationToken, RememberMeAuthenticationToken  {
    ...
    public UsernamePasswordAndClientToken(final String username, final char[] password,  final boolean rememberMe, final String host) {
    ...
    public UsernamePasswordAndClientToken(final String username, final String password, final boolean rememberMe, final String host) {
