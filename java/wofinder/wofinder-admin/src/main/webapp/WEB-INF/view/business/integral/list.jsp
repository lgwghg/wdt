...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/customer/business/integral/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="userIntegral:add">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/userIntegral/addUI.html')" class="btn btn-primary btn-sm">
		  	<i class="fa fa-user-plus"></i>&nbsp;添加
		</button>
	</shiro:hasPermission>
	<shiro:hasPermission name="userIntegral:edit">
		<button id="btnEdit" type="button" onclick="webside.common.editModel('/userIntegral/editUI.html')" class="btn btn-success btn-sm">
