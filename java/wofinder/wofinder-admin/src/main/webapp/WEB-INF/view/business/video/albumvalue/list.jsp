...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/albumvalue/list.js"></script>
<script>
...
<div class="modal-header">
	<h4 class="modal-title">视频属性值关联列表</h4>
</div>

<div class="modal-body" style="height: 700px;">
	<div class="page-header">
		<shiro:hasPermission name="videoAlbumValue:addUI">
			<button type="button" data-toggle="modal" data-target="#formModal" href="${ctx }/videoAlbumValueCtrl/addUI.html?videoAlbumId=${videoAlbumId}" class="btn btn-primary btn-sm">
		...
		<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
			<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
				<div class="widget-header">
					<h4 class="widget-title lighter">视频专辑属性值关联列表</h4>
				...
				<div class="widget-body" style="display: block;">
					<div class="widget-main padding-6 no-padding-left no-padding-right">
						...
						<input id="videoAlbumId" type="hidden" value="${videoAlbumId }">
