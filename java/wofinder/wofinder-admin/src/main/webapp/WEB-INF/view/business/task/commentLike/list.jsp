...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/taskcommentlike/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="taskCommentLike:addUI">
		<button type="button" onclick="webside.common.addModel('/taskCommentLike/addUI.html')" class="btn btn-primary btn-sm">
