...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/task/task/list.js"></script>
<script>
var formClose = false;
...
<div class="page-header">
	<shiro:hasPermission name="task:addUI">
		<button type="button" onclick="webside.common.addModel('/taskCtrl/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
	<label class="search">作者名称：
		<input id="upId" type="hidden"/>
		<input id="upName" type="text" placeholder="作者名称..." onfocus="webside.wodota.show('searchModal',this)" href="${ctx }/upCtrl/searchListUI.html">
	</label>
	...
	<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
		<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
			<div class="widget-header">
				<h4 class="widget-title lighter">事件列表</h4>
