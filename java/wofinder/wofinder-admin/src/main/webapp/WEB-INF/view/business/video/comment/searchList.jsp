...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/comment/searchList.js"></script>

<div class="modal-header">
	<h4 class="modal-title">视频评论列表</h4>
</div>

<div class="modal-body" style="height: 600px;">
	<div class="input-group" >
		<label class="search">评论内容：<input id="commentContent_search" type="text" placeholder="名称..."></label>
		<c:if test="${empty stationValue }">
			<label class="search">所属站点：
				<select id="stationValue_search" style="width: 170px;">
		...
		<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
			<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
				<div class="widget-header">
					<h4 class="widget-title lighter">视频评论列表</h4>
				...
				<div class="widget-body" style="display: block;">
					<div class="widget-main padding-6 no-padding-left no-padding-right">
						...
						<input id="stationValue_search" type="hidden" value="${stationValue}">
						<input id="videoId_search" type="hidden" value="${videoId}">
