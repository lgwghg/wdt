...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/up/value/form.js"></script>
...
<div class="modal-body" >
	<div class="row" style="margin-top:5px;">
		<div class="col-xs-12">
			<form id="upvalue-form" name="upvalue-form" class="form-horizontal" role="form" method="post">
				<c:if test="${ !empty entity }">
...
<div class="modal-footer" style="text-align: center;">
	<button type="button" onclick="javascript:$('#upvalue-form').submit();" class="btn btn-success btn-sm">
