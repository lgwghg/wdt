...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/task/value/form.js"></script>
...
<div class="modal-body" >
	<div class="row" style="margin-top:5px;">
		<div class="col-xs-12">
			<form id="taskvalue-form" name="taskvalue-form" class="form-horizontal" role="form" method="post">
				<c:if test="${ !empty entity }">
...
<div class="modal-footer" style="text-align: center;">
	<button type="button" onclick="javascript:$('#taskvalue-form').submit();" class="btn btn-success btn-sm">
