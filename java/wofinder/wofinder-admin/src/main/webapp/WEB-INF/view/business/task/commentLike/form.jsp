...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/taskcommentlike/form.js"></script>
...
<div class="row" style="margin-top:5px;">
	<div class="col-xs-12">
		<form id="taskcommentlike-form" name="taskcommentlike-form" class="form-horizontal" role="form" method="post">
			<c:if test="${ !empty entity }">
			...
			<div class="form-group">
		      <label class="control-label col-sm-1 no-padding-right" for="commentId">评论 t_task_comment</label>
		      <div class="col-sm-10">
			      <div class="clearfix">
			         <input class="form-control" name="commentId" type="text" 
			           		value="${ entity.commentId }" placeholder="评论 t_task_comment..."/>
			      </div>
		      </div>
			</div>
			<div class="form-group">
...
<div class="center">
	<button type="button" onclick="javascript:$('#taskcommentlike-form').submit();" class="btn btn-success btn-sm">
	...
	<button type="button" onclick="webside.common.loadPage('/taskCommentLike/listUI.html<c:if test="${!empty entity}">?page=${page.pageNum}&rows=${page.pageSize}&sidx=${page.orderByColumn}&sord=${page.orderByType}</c:if>')" class="btn btn-info btn-sm">
