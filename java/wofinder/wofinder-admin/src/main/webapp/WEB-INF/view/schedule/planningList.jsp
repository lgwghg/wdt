...
<div class="page-header">
	...
	<shiro:hasPermission name="schedule:executeJob">
		<button id="btnDel" type="button" onclick="webside.form.schedule.executeJob('/scheduleJob/executeJob.html', customSearch)" class="btn btn-primary btn-sm">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">计划中任务列表</h4>
