...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/video/searchList.js"></script>
...
<div class="modal-body" style="height: 600px;">
	<div class="input-group" >
		<label class="search">标题：<input id="title_search" type="text" placeholder="标题..."></label>
