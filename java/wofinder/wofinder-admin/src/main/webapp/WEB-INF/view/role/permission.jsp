...
<div class="center">
	<button id="btnAdd" type="button" onclick="webside.form.resource.authorize.commitPerm('/role/permission.html' , '/role/listUI.html')" class="btn btn-success btn-sm">
		...
		<button id="btn" type="button" onclick="webside.common.loadPage('/role/listUI.html?page=${page.pageNum }&rows=${page.pageSize }&sidx=${page.orderByColumn }&sord=${page.orderByType }')" class="btn btn-primary btn-sm">
