...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/video/list.js"></script>
<script>
var formClose = false;
...
<div class="page-header">
	<shiro:hasPermission name="video:addUI">
		<button type="button" onclick="webside.common.addModel('/videoCtrl/addUI.html')" class="btn btn-primary btn-sm">
...
<div class="input-group" >
	...
	<label class="search">游戏：
		...
		<input id="gameName" type="text" onfocus="this.blur()" onclick="webside.wodota.show('searchModal',this)" href="${ctx }/sysGameCtrl/searchListUI.html"
			placeholder="游戏名称..."/>
	</label>
	...
	<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
		<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
			<div class="widget-header">
				<h4 class="widget-title lighter">视频列表</h4>
