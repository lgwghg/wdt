...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/sys/attribute/list.js"></script>

<div class="page-header">
	<shiro:hasPermission name="sysAttribute:addUI">
		<button type="button" onclick="webside.common.addModel('/sysAttributeCtrl/addUI.html')" class="btn btn-primary btn-sm">
	...
	<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
		<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
			<div class="widget-header">
				<h4 class="widget-title lighter">属性列表</h4>
