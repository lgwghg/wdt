<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/customer/role/roleUserList.js"></script>
<div class="page-header">
	...
	<button id="btnSetResource" type="button" onclick="webside.common.editModel('/role/permissionUI.html')" class="btn btn-primary btn-sm">
		<i class="fa fa-gears"></i>&nbsp;分配权限
	</button>
	</shiro:hasPermission>
</div>
<div class="input-group">
	 <input id="roleId" type="hidden" class="input form-control" value="${roleId }">
