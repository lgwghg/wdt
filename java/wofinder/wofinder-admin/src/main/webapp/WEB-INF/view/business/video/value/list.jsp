...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/value/list.js"></script>
<script>
...
<div class="modal-body" style="height: 700px;">
	<div class="page-header">
		<shiro:hasPermission name="videoValue:addUI">
			<button type="button" data-toggle="modal" data-target="#formModal" href="${ctx }/videoValueCtrl/addUI.html?videoId=${videoId}" class="btn btn-primary btn-sm">
	...
	<div class="input-group" >
		...
		<%-- <label class="search">属性值：
			<select id="valueId_v" style="width: 170px;">
	   			<option value="">不限</option>
		...
		<div class="col-xs-12 widget-container-col ui-sortable" style="min-height: 127px;">
			<div class="widget-box transparent ui-sortable-handle" style="opacity: 1; z-index: 0;">
				<div class="widget-header">
					<h4 class="widget-title lighter">视频属性值关联列表</h4>
