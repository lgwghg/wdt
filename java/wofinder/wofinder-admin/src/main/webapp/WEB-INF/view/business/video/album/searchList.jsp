...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/album/searchList.js"></script>

<div class="modal-header">
	<h4 class="modal-title">视频专辑列表</h4>
</div>

<div class="modal-body" style="height: 600px;">
	<div class="input-group" >
		<label class="search">名称：<input id="name_search" type="text" placeholder="名称..."></label>
