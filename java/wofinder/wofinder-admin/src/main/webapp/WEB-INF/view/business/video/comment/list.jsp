...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/comment/list.js"></script>
<script>
...
<div class="modal-body" style="height: 600px;">
	<div class="page-header">
		<shiro:hasPermission name="videoComment:addUI">
			<button type="button" data-toggle="modal" data-target="#formModal" href="${ctx }/videoCommentCtrl/addUI.html?videoId=${videoId}" class="btn btn-primary btn-sm">
	...
	<div class="input-group" >
		<label class="search">所属站点：
			<select id="stationValue_c" style="width: 170px;">
