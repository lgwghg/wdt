		...
		<input type="hidden" name="jobGroup" id="jobGroup" value="${scheduleJobEntity.jobGroup }"/>
		  <div class="form-group">
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		      <div class="clearfix">
		         <input class="form-control date-picker" name="startDate2" id="startDate" type="text"
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		      <div class="clearfix">
		         <input class="form-control date-picker" name="endDate2" id="endDate" type="text"
...
<div class="center">
	<button id="btnAdd" type="button" onclick="javascript:$('#triggerForm').submit();" class="btn btn-success btn-sm">
		...
		<button id="btn" type="button" onclick="webside.common.loadPage('/scheduleJob/jobTriggerListUI.html?jobName=${scheduleJobEntity.jobName }&jobGroup=${scheduleJobEntity.jobGroup }')" class="btn btn-primary btn-sm">
