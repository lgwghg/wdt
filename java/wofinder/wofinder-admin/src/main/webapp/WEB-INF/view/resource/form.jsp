...
<div class="center">
	...
	<button id="btn" type="button"
		onclick="webside.common.loadPage('/resource/listGridUI.html<c:if test="${!empty resourceEntity}">?page=${page.pageNum }&rows=${page.pageSize }&sidx=${page.orderByColumn }&sord=${page.orderByType }</c:if>')"
