...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/up/value/list.js"></script>
<script>
...
<div class="modal-header">
	<h4 class="modal-title">视频作者属性值关联列表</h4>
</div>

<div class="modal-body" style="height: 700px;">
	<div class="page-header">
		<shiro:hasPermission name="upValue:add">
			<button type="button" data-toggle="modal" data-target="#formModal" href="${ctx }/upValueCtrl/addUI.html?upId=${upId}" class="btn btn-primary btn-sm">
		...
		<div class="col-xs-12 widget-container-col ui-sortable"
			...
			<div class="widget-box transparent ui-sortable-handle"
				...
				<div class="widget-header">
					<h4 class="widget-title lighter">视频作者属性值关联列表</h4>
