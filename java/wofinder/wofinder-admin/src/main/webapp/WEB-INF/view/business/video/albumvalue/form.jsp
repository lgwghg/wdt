...
<script type="text/javascript" src="${ ctx}/resources/js/customer/business/video/albumvalue/form.js"></script>
...
<div class="modal-body" >
	<div class="row" style="margin-top:5px;">
		<div class="col-xs-12">
			<form id="videoalbumvalue-form" name="videoalbumvalue-form" class="form-horizontal" role="form" method="post">
				<c:if test="${ !empty entity }">
					...
					<input type="hidden" name="videoAlbum.id" value="${entity.videoAlbum.id}">
				</c:if>
				<c:if test="${ empty entity }">
					<input type="hidden" name="videoAlbum.id" value="${videoAlbumId}">
				</c:if>
...
<div class="modal-footer" style="text-align: center;">
	<button type="button" onclick="javascript:$('#videoalbumvalue-form').submit();" class="btn btn-success btn-sm">
