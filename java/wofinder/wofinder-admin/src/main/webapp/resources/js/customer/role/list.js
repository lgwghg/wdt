var dtGridColumns = [/*{
    ...
    resolution : function(value, record, column, grid, dataNo, columnNo) {
        if(value == 0)
        {
            return '<span class="label label-sm label-success arrowed arrowed-righ">官方网站组</span>';
        }else if (value == 1)
        {
            return '<span class="label label-sm label-warning arrowed arrowed-righ">普通用户组</span>';
        }
    }
}, {
    id : 'name',
