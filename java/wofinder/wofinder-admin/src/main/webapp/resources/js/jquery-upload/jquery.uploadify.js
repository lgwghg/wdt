(function($){
	$.fn.Huploadify = function(opts){
		...
		var itemTemp = '<div id="${fileID}" class="uploadify-queue-item"><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div><span class="up_filename">${fileName}</span></div>';
		var defaults = {
		...
		this.each(function(index, element){
			...
			var uploadManager = {
				...
				init : function(){
					...
					inputStr += '</a>';
					var uploadFileListStr = '<div id="'+_this.attr("id")+'_file_upload_'+instanceNumber+'-queue" class="uploadify-queue"></div>';
