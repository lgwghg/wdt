	...
	Plugin.prototype = {
		...
		initTemplate: function() {
			this.template = '<div class="dtp hidden" id="' + this.name + '">' +
				...
				'</div>' +
				'<div class="dtp-actual-day p40">Lundi</div>' +
				'<div class="dtp-actual-month p30">MAR</div>' +
				'<div class="dtp-actual-num p80">13</div>' + '<div class="ritext">日</div>' +
				...
				//'<button class="btn btn-flat okey">确认</button>' +
				//'<button class="btn btn-flat closeab">取消</button>' +
				'<button class="dtp-btn-ok btn btn-flat okey">' + this.params.okText + '</button>' +
				'<button class="dtp-btn-cancel btn btn-flat closeab">' + this.params.cancelText + '</button>' +
				'<div class="clearfix"></div>' +
				'</div>' +
				'</div>' +
				'</div>';
